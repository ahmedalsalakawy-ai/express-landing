        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-4 leading-tight">
              <span className="text-amber-400">Express</span> Accounting System
            </h1>
            
            <p className="text-lg text-blue-200 mb-6">Powered by Practivist</p>
            
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Complete accounting solution designed for scaffolding, heavy equipment, and vehicle rental companies
            </p>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                'Effortless contract and rental tracking',
                'Real-time profit and loss reports',
                'Easy-to-use interface in Arabic & English'
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              <div>
                ...
                <div className="text-sm text-blue-200">Companies Waiting</div>
              </div>
          ...
          >
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 border-4 border-amber-400/50">
              ...
              <div className="aspect-video bg-gradient-to-br from-blue-50 to-slate-100 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 font-medium">Express Dashboard</p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-lg font-bold text-slate-800">+25,000 AED</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-slate-500">Rented Equipment</div>
