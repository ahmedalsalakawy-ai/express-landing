      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
              Complete accounting system designed specifically for scaffolding, heavy equipment, and vehicle rental companies
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-slate-300">
              ...
              <li className="pt-2">
                <Link href="/" className="inline-flex items-center gap-2 text-amber-400 hover:text-amber-300 font-semibold">
                  🇦🇪 العربية
                </Link>
              </li>
            </ul>
        ...
        >
          ...
          <p className="mt-2 text-sm">
            Powered by ♥️ <a href="https://practivist.ae" className="text-amber-400 hover:text-amber-300">Practivist</a>
          </p>
        </motion.div>
      </div>
    </footer>
